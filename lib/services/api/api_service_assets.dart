...
//   static Future<RepositoryOfAsset> addAsset({body}) async {
...
//         print("<----- SalesPrice => ${jsonDecode(res.data)['SalesPrice']}");
...
//   static Future<ResponseDetailOfAsset> getDetailAseet({body}) async {
//     // print(wtokenID);
//     FormData formData = FormData.from(body);
...
//   static Future<ResponseDetailOfAsset> deleteAseet({body}) async {
//     // print(wtokenID);
